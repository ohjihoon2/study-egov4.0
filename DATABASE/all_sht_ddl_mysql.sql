...
CREATE TABLE comtNEMPLYRINFO (
  ...
  KEY comtNEMPLYRINFO_ibfk_2 (GROUP_ID),
  KEY comtNEMPLYRINFO_ibfk_1 (ORGNZT_ID),
...
CREATE TABLE comtNENTRPRSMBER (
  ...
  KEY comtNENTRPRSMBER_ibfk_1 (GROUP_ID),
...
CREATE TABLE comtNGNRLMBER (
  ...
  ESNTL_ID char(20) NOT NULL,
  PRIMARY KEY (MBER_ID),
  KEY comtNGNRLMBER_ibfk_1 (GROUP_ID),
